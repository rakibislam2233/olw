...
const GetStartedSection = () => {
  ...
  return (
    <section className="w-full bg-white py-10 md:py-[50px]">
      <div className="w-full max-w-5xl mx-auto px-4 md:px-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-16">
          {steps.map((step, index) => (
            <div key={index} className="flex flex-col items-center">
              <div className="relative w-full max-w-[325px] h-[195px] bg-white border-2 border-primary/10 rounded-[11.44px] flex items-center justify-center mb-8 shadow-[0px_4.58px_34.33px_rgba(250,196,210,0.12)]">
                {/* Step Number Bubble */}
                <div className="absolute -top-5 -left-5 size-[76] rounded-full border-[5px] border-primary bg-white flex items-center justify-center text-[22.88px] font-bold text-[#1E1E1E] shadow-sm">
                  {step.id}
                </div>
                {/* Icon */}
